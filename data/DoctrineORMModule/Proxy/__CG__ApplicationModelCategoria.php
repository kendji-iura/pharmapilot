 ...
 */
class Categoria extends \Application\Model\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Model\\Categoria' . "\0" . 'id', '' . "\0" . 'Application\\Model\\Categoria' . "\0" . 'nome'];
        }
