...
class Cliente extends \Application\Model\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Model\\Cliente' . "\0" . 'id', '' . "\0" . 'Application\\Model\\Cliente' . "\0" . 'nome', '' . "\0" . 'Application\\Model\\Cliente' . "\0" . 'email', '' . "\0" . 'Application\\Model\\Cliente' . "\0" . 'telefone', '' . "\0" . 'Application\\Model\\Cliente' . "\0" . 'ativo'];
        }
