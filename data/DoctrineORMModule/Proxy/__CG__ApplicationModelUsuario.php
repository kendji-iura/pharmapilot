 ...
 */
class Usuario extends \Application\Model\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Model\\Usuario' . "\0" . 'id', '' . "\0" . 'Application\\Model\\Usuario' . "\0" . 'nome', '' . "\0" . 'Application\\Model\\Usuario' . "\0" . 'email', '' . "\0" . 'Application\\Model\\Usuario' . "\0" . 'senha', '' . "\0" . 'Application\\Model\\Usuario' . "\0" . 'tipo', '' . "\0" . 'Application\\Model\\Usuario' . "\0" . 'ativo'];
        }
